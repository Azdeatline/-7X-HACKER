...
bot = telebot.TeleBot('7848872354:AAGdtRQ15Q8ko0AxLrZq5OKZNJMlqvDo6Nc')
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 20:
                response = "You Are On Cooldown ❌. Please Wait 0 sec Before Running The /bgmi Command Again."
                bot.reply_to(message, response)
                return
...
Buy From :- @SUKUNAA_XD
Official Channel :- https://t.me/+sJ9B3vLpO1RmZTQ1
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to DDOS 🚀, {user_name}! SASTA HAI KHARID LO ABHI .
🤖Try To Run This Command : /help 
✅Join :- https://t.me/+sJ9B3vLpO1RmZTQ1'''
    bot.reply_to(message, response)
